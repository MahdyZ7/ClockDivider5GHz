...
## name of current desin (change it based on top block)
...
####################################################################
set_app_var hdlin_sv_enable_rtl_attributes true
## put constrains file (change it based on your constrain file)
...
# Change name
write -format verilog -hier -o ./${TRIAL_DIR}/netlists/BIGDIV_5GHz.v 
