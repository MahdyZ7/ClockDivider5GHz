...
current_design dividerblock  #change name
...
set_app_var hdlin_sv_enable_rtl_attributes true
## put constrains file -.-
source -echo -verbose ./myconstraints.sdc     > ${TRIAL_DIR}/reports/d05_constr_clk.rpt # change Constrain
...
write -format verilog -hier -o ./${TRIAL_DIR}/netlists/BIGDIV_5GHz.v # Change name
